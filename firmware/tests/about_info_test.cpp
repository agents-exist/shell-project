...
int main() {
  ...
  expect_str_eq(info.source_line_1, "shell-project", "about page source should match the project name");
  expect_str_eq(info.source_line_2, "CodeBuddy port", "about page should describe the firmware origin");
